...
district_program_2018_cast <-  district_program_2018_cast %>% mutate(total = district_program_2018_cast$administration+ district_program_2018_cast$community_education+ district_program_2018_cast$district_support_services+ district_program_2018_cast$ell+ district_program_2018_cast$extra_curriculars + district_program_2018_cast$instruction + district_program_2018_cast$instructional_support_services+ district_program_2018_cast$pupil_support_services + district_program_2018_cast$special_education,
...
#Pct spent on ELL
```{r}
district_program_2018_cast %>% select(district_name, total, ell) %>%
  mutate(pct_ell = ell/total) %>% 
